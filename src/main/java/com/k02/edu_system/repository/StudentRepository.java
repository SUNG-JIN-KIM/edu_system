package com.k02.edu_system.repository;

import com.k02.edu_system.model.Student;
...
public class StudentRepository {
    ...
    // 👉 추가된 메서드
    public int countByTeacherId(int teacherId) {
        String sql = "SELECT COUNT(*) FROM student WHERE teacher_id = ?";
